			...
			<div class="row">
				<div class="col-md-9">
					...
					<div class="row">
						...
						<div class="col-md-4 mb-3">
							<label class="form-label">Plate Name</label> <select
								class="form-select" id="plateNameId" name="plateNameId" required>
					...
					<div id="statDropdownWrapper" class="mb-3" style="display: none;">
						...
						<div class="row mt-3">
							<div class="col-md-6 mb-3">
								<label class="form-label">Value (Unit)</label> <input
									type="text" class="form-control number-only-input"
							...
							<div class="col-md-6 mb-3">
								<label class="form-label">Value (%)</label> <input type="text"
									class="form-control decimal-only-input" id="statPercent"
									name="statPercent" value="${plate.statPercent}"
