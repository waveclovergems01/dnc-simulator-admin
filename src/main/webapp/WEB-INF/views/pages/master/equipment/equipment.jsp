...
<div class="d-flex justify-content-between align-items-center mb-3">
	...
	<div>
		<a href="${pageContext.request.contextPath}/master/equipment/add"
			class="btn btn-primary me-1"> + Add Equipment </a>
		<a href="${pageContext.request.contextPath}/master/equipment/clone-set"
...
<div class="card p-3 mb-3 shadow-sm">
	<div class="row g-3">
		...
		<div class="col-md-3">
			<label class="form-label">Filter by Set</label>
			<select id="setFilter" class="form-select">
				<option value="">-- All Sets --</option>
				<c:forEach items="${setBonuses}" var="s">
					<option value="${s.setName}">${s.setName} (ID: ${s.setId})</option>
				</c:forEach>
			</select>
		</div>
	...
	<tbody>
		<c:forEach items="${items}" var="e">
			<tr>
				...
				<td class="text-center">
					<a href="${pageContext.request.contextPath}/master/equipment/edit?itemId=${e.itemId}"
						class="btn btn-sm btn-warning me-1">Edit</a>

					<a href="${pageContext.request.contextPath}/master/equipment/clone?itemId=${e.itemId}"
						class="btn btn-sm btn-info me-1">Clone</a>

					<form action="${pageContext.request.contextPath}/master/equipment/delete"
...
<script
	src="${pageContext.request.contextPath}/resources/js/master/equipment/equipment.js"></script>